This is a simple agent that retrieves text logs from Youtube videos and then creates a social media post using the text log automatically. With emoticons !
